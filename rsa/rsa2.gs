...
function RSASetPrivate(N,E,D) {
  ...
  if (typeof N !== "string")
  {
    ...
    Browser.msgBox("Invalid RSA private key");
}

// Set the private key fields N, e, d and CRT params from hex strings
function RSASetPrivateEx(N,E,D,P,Q,DP,DQ,C) {
  this.isPrivate = true;
  var errorMsg = "Invalid RSA Private Key."
  if (N == null) throw errorMsg; //"RSASetPrivateEx N == null";
  if (E == null) throw errorMsg; //"RSASetPrivateEx E == null";
  if (N.length == 0) throw errorMsg //"RSASetPrivateEx N.length == 0";
  if (E.length == 0) throw errorMsg //"RSASetPrivateEx E.length == 0";
